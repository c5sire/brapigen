...
brapi_post_vendor_orders(con = con, clientId = "BrAPIR", numberOfSamples = 4, sampleType = "DNA", serviceIds = "vsp1", requiredServiceInfo = list(additionalProp1 = "stringAddProp1", additionalProp2 = "stringAddProp2", additionalProp3 = "stringAddProp3"), plates = plates) # 92 Requirements: con$token <- "YYYY" for plates see example section of documentation
